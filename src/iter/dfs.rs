use super::{IterKindCore, IterOver, OverData};
...
impl Dfs {
    ...
    ///
    /// This method crates an iterable `DfsData<V>` which allocates the stack once on initialization;
    ...
    /// ```
    pub fn over_data<V: TreeVariant>() -> DfsData<V> {
        Default::default()
    }
}
...
pub type DfsData<V: TreeVariant> = DfsCore<V, OverData>;
